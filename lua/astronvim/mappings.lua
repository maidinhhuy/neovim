...
maps.n["<leader-s>"] = { "<cmd>w!<cr>", desc = "Force write" }
maps.n["<leader-q>"] = { "<cmd>qa!<cr>", desc = "Force quit" }
...
if is_available "telescope.nvim" then
  maps.n["<C-f>"] = sections.f
  maps.n["<C-g>"] = sections.g
  maps.n["<leader>gb"] =
...
if is_available "toggleterm.nvim" then
  ...
  maps.t["<F7>"] = maps.n["<F7>"]
  maps.n["<leader-'>"] = maps.n["<F7>"] -- requires terminal that supports binding <C-'>
  maps.t["<leader-'>"] = maps.n["<F7>"] -- requires terminal that supports binding <C-'>
  maps.n["<leader-t"] = maps.n["<F7>"]
end
...
maps.t["<leader-h>"] = { "<cmd>wincmd h<cr>", desc = "Terminal left window navigation" }
maps.t["<leader-j>"] = { "<cmd>wincmd j<cr>", desc = "Terminal down window navigation" }
maps.t["<leader-k>"] = { "<cmd>wincmd k<cr>", desc = "Terminal up window navigation" }
maps.t["<leader-l>"] = { "<cmd>wincmd l<cr>", desc = "Terminal right window navigation" }
